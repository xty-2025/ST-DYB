...
from models_GAT_fourier_and_self_att_fuse.model import fourier_and_self_att_fuse
...
if __name__ == "__main__":
   ...
   # item_graphs
    ...
    model = fourier_and_self_att_fuse(args, feats[0].shape[1], args.time_steps).to(device)

...
from models_GAT_fourier_and_diffusion.model import fourier_and_diffusion
...
if __name__ == "__main__":
    ...
    parser.add_argument('--learning_rate', type=float, nargs='?', default=0.05,
   ...
   # item_graphs
    ...
    model = fourier_and_diffusion(args, feats[0].shape[1], args.time_steps).to(device)

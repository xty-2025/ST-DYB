...
if __name__ == "__main__":
    ...
    parser.add_argument('--graph_name', type=str, nargs='?',
                        default='/root/DySAT_pytorch10_27copy/data/movie_sma/graphs.pkl',
                        help='graph name')
    parser.add_argument('--total_graph_name', type=str, nargs='?',
                        default='/root/DySAT_pytorch10_27copy/data/movie_sma/total_graphs.pkl',
    ...
    parser.add_argument('--useradj_name', type=str, nargs='?',
                        default='/root/DySAT_pytorch10_27copy/data/movie_sma/user_adj.pkl',
                        help='useradj name')
    parser.add_argument('--context_pairs_path', type=str, nargs='?',
                        default='/root/DySAT_pytorch10_27copy/data/movie_sma/context_pairs.pkl',
                        help='result of randomwalk')
    parser.add_argument('--datapath', type=str, nargs='?', default='/root/DySAT_pytorch10_27copy/data/movie_sma',
                        help='datapath')

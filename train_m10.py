...
if __name__ == "__main__":
    ...
    parser.add_argument('--time_steps', type=int, nargs='?', default=13,
                        help="total time steps used for train, eval and test")
    parser.add_argument('--topk', type=int, nargs='?', default=10,
                        help="topk num")
    parser.add_argument('--total_node', type=int, nargs='?', default=20330,
                        help="total node")
    parser.add_argument('--user_num', type=int, nargs='?', default=3962,
                        help="user_num")
    parser.add_argument('--graph_name', type=str, nargs='?',
                        default='/root/DySAT_pytorch10_27copy/data/movie/graphs.pkl',
                        help='graph name')
    ...
    parser.add_argument('--weight_decay', type=float, nargs='?', default=0.0005,
                        help='Initial learning rate for self-attention model.')
    # Architecture params
    parser.add_argument('--GCN_layer_config', type=str, nargs='?', default='128',

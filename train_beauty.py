...
if __name__ == "__main__":
    ...
    parser.add_argument('--total_node', type=int, nargs='?', default=5574,
                        help="total node")
    parser.add_argument('--user_num', type=int, nargs='?', default=2491,
                        help="user_num")
    parser.add_argument('--graph_name', type=str, nargs='?',
                        default='/root/DySAT_pytorch10_27copy/data/beauty/graphs.pkl',
                        help='graph name')
    ...
    parser.add_argument('--useradj_name', type=str, nargs='?',
                        default='/root/DySAT_pytorch10_27copy/data/beauty/user_adj.pkl',
                        help='useradj name')
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        emb = np.array(emb)
        print(emb)
        print('QAAAAAAAAAAAAAAAAAAAA',len(emb))

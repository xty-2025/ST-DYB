...
from models_GAT_fourier_and_self_att.layers import StructuralAttentionLayer, TemporalAttentionLayer, GCNLayer
from models_GAT_fourier_and_self_att.TimeNet import TimeNet
from utils.utilities import fixed_unigram_candidate_sampler

class fourier_and_self_att(nn.Module):
    def __init__(self, args, num_features, time_length):
        ...
        """
        super(fourier_and_self_att, self).__init__()
        self.args = args
        if args.window < 0:

...
from models_GAT_GAT_fourier.layers import StructuralAttentionLayer, TemporalAttentionLayer, GCNLayer
from models_GAT_GAT_fourier.TimeNet import TimeNet
...
class DySAT(nn.Module):
    ...
    def forward(self, args, user_graphs,total_graphs,item_graphs):
        ...
        temporal_user_resnet = temporal_user_out# 16 190 16
        temporal_item_resnet = temporal_item_out# 16 610 16

        temp_user =  self.time_emb(temporal_user_out)
        temp_item = self.time_emb(temporal_item_out)
        H_user = temporal_user_resnet + args.fourier_inf_alpha *temp_user #16 190 16
        H_item = temporal_item_resnet + args.fourier_inf_alpha *temp_item   # 16 610 16
